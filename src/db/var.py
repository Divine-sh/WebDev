...
sql_create = [
    ...
    """
        (   
            req_cmty     VARCHAR (50) UNIQUE KEY,
            req_id       VARCHAR (50) UNIQUE KEY,
            req_uid      VARCHAR (50) UNIQUE KEY,  
            req_type     INT NOT NULL,
            req_topic    VARCHAR (100) UNIQUE KEY,
            req_idct     VARCHAR (300) UNIQUE KEY,
